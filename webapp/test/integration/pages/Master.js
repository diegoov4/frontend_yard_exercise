		...
		onTheMasterPage: {
			...
			actions: {
				...
				iFilterTheListOnUnitNumber: function () {
					return this.iChooseASorter("filterButton", "<EmployeeID>", "<100 <Country>");
				},

				iGroupTheList: function () {
					return this.iChooseASorter("groupButton", "<EmployeeID> Group");
				},
			...
			assertions: {
				...
				theListShouldBeFilteredOnUnitNumber: function () {
					return this.theListShouldBeFilteredOnFieldUsingComparator("EmployeeID", 100);
				},
